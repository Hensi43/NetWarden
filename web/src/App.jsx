    ...
    <div className="flex w-full h-screen bg-slate-50 text-slate-900 overflow-hidden font-sans">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden bg-slate-50">
        ...
        <header className="h-16 border-b border-slate-200 bg-white flex items-center justify-between px-6 shrink-0">
          <h1 className="text-xl font-semibold text-slate-900 capitalize">{activeTab} Overview</h1>
        ...
        <div className="flex-1 overflow-y-auto p-6 scroll-smooth">
            ...
            <div className="space-y-6 max-w-7xl mx-auto fade-in">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[500px]">
                ...
                <div className="lg:col-span-2 flex flex-col gap-6 h-full">
                  <div className="h-64 bg-white border border-slate-200 rounded-lg p-4 shadow-sm">
                    <h3 className="text-sm font-medium text-slate-600 mb-4 px-2">Network Traffic History</h3>
                ...
                <div className="lg:col-span-1 bg-white border border-slate-200 rounded-lg p-1 flex flex-col h-full shadow-sm relative overflow-hidden">
                  <div className="absolute top-3 left-4 z-10 pointer-events-none">
                    <h3 className="text-sm font-medium text-slate-700">Live Map</h3>
                  </div>
          ...
          {activeTab === 'topology' && (
            <div className="h-full w-full bg-white border border-slate-200 rounded-lg overflow-hidden fade-in relative">
              <NetworkGraph processes={data.processes} />
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur border border-slate-200 p-4 rounded-lg max-w-xs text-xs text-slate-600 space-y-2">
                <p className="font-semibold text-slate-900">Grid Controls</p>
          ...
          {activeTab === 'rules' && (
            <div className="flex items-center justify-center h-full text-slate-500 fade-in">
              <div className="text-center">
                ...
                <h2 className="text-lg font-semibold text-slate-700">Policy Management</h2>
